...
fun AffirmationCard(affirmation: Affirmation, modifier: Modifier = Modifier) { //take an Affirmation object as a parameter. The Affirmation object comes from the model package.
    ...
    Card(modifier = modifier){
        Column {
            Image(
                painter = painterResource(affirmation.imageResourceId), //will load either vector drawables or rasterized asset formats like PNGs
            ...
            Text(
                text = LocalContext.current.getString(affirmation.stringResourceId), // pq temos de ir buscar o context aqui ? pq n só o getString
